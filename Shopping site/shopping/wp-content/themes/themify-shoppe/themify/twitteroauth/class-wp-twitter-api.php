...
class Wp_Twitter_Api {
	...
	private function get_bearer_token() {
		...
		if ( is_wp_error( $response ) || 200 != $response['response']['code'] )
			return $this->bail( apply_filters( 'themify_twitter_missing_key_message', sprintf( __( 'Error: access keys missing in <a href="%s">Themify > Settings > Integration API</a>', 'themify' ), admin_url( 'admin.php?page=themify#setting-twitter_settings' ) ) ), $response );
