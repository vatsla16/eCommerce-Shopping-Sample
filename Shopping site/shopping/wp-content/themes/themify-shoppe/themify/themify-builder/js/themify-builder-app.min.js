...
url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_library_item",nonce:themifyBuilder.tb_load_nonce,type:b,id:a},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(b){ThemifyBuilderCommon.showLoader("hide");"success"===b.status?(c.items[a]=b.content,d(b.content)):ThemifyBuilderCommon.showLoader("error")},error:function(){ThemifyBuilderCommon.showLoader("error")}})}},template:function(a){for(var b="",d=0,f=a.length;d<f;++d){var e="part";-1!==a[d].post_type.indexOf("_rows",
5)?e="row":-1!==a[d].post_type.indexOf("_module",5)&&(e="module");b+='<div class="tb_library_item tb_item_'+e+'" data-type="'+e+'" data-id="'+a[d].id+'">';b+='<div class="tb_library_item_inner"><span>'+a[d].post_title+"</span>";b+='<a href="#" class="remove_item_btn" title="Delete"></a></div></div>'}return b},bindEvents:function(a){"visual"===b.mode?(b.Mixins.Builder.initModuleVisualDrag(".tb_item_module,.tb_item_part"),b.Mixins.Builder.initRowVisualDrag(".tb_item_row")):(b.Mixins.Builder.initRowDraggable(b.toolbar.$el.find(".tb_module_panel_library_wrap").first(),
...
b.liveStylingInstance.setStylingVal(c,f);Themify.body.trigger("builder_load_module_partial",[b.liveStylingInstance.$liveStyledElmt,b.liveStylingInstance.type])}else"row_height"===c||"row_width"===c?Themify.body.trigger("tb_row_"+c.replace("row_",""),f):a.preview_element(f)});return this}});b.Views.register_control("toggle_switch",{initialize:function(){this.render()},render:function(){var a=this,b=a.el.nextElementSibling;b.checked=a.el.value===b.getAttribute("data-on-val");b.addEventListener("change",
_.throttle(function(b){a.el.value=this.checked?this.getAttribute("data-on-val"):this.getAttribute("data-off-val");Themify.triggerEvent(a,"change");a.preview_element(a.el.value)},100));return this}});b.Views.register_control("checkbox",{initialize:function(){this.render()},render:function(){var a=this;this.$('input[type="checkbox"]').click(function(){if(void 0!==a.binding_type){var b=a.$('input[type="checkbox"]:checked').map(function(){return this.value}).get();a.preview_element(b.join("|"))}});return this}});
b.Views.register_control("color",{is_typing:!1,initialize:function(){this.render()},render:function(){var a=this,c=this.$el.next(".color_opacity"),d=this.$el.prop("id");this.$el.minicolors({opacity:1,changeDelay:200,beforeShow:function(){var b=ThemifyBuilderCommon.Lightbox.$lightbox,c=a.$el.closest(".minicolors"),d=c.find(".minicolors-panel");d.css("visibility","hidden").show();b.offset().left+b.width()<=d.offset().left+d.width()?c.addClass("tb_minicolors_right"):c.removeClass("tb_minicolors_right");
d.css("visibility","").hide()},hide:function(){var b=a.$el.siblings(".tb_clear_btn");""!==a.$el.val()?b.show():b.hide()},change:function(f,g){f?g&&"0.99"==g?g=1:g&&0>=parseFloat(g)&&(g=0):g="";a.is_typing||c.is(":focus")||c.attr("data-opacity",g).data("opacity",g).val(g);f&&0>=parseFloat(e(this).minicolors("opacity"))&&e(this).minicolors("opacity",0);var h=f?e(this).minicolors("rgbaString"):"";if(void 0!==a.binding_type)a.preview_element(h);else if("visual"===b.mode&&(Themify.body.trigger("themify_builder_color_picker_change",
[d,a.$el,f?h:""]),-1!==d.indexOf("font_color"))){var k="";"font_color"!=d&&(k="_"+d.slice(-2));var l=ThemifyBuilderCommon.Lightbox.$lightbox,h=l.find("#font_color_type"+k+"_font_gradient_color"+k+"_gradient"),k=l.find("#font_color_type"+k+"_font_color"+k+"_solid");k.length&&h.length&&(h.click(),k.click())}}}).minicolors("show");a.el.parentNode.insertAdjacentHTML("beforeend",'<div class="tb_clear_btn"></div>');b.Utils.createClearBtn(a.$el);c.on("blur keyup",function(b){var c=parseFloat(e.trim(e(this).val()));
if(1<c||isNaN(c)||""===c||0>c)c=a.$el.val()?1:"","blur"===b.type&&e(this).val(c);e(this).attr("data-opacity",c);a.is_typing="keyup"===b.type;a.$el.minicolors("opacity",c)})}});b.Views.register_control("repeater",{events:{"click .toggle_row":"toggleField","click .tb_duplicate_row":"duplicateRowField","click .tb_delete_row":"deleteRowField"},initialize:function(){this.render()},render:function(){var a=this.$el,b=this,d=!1;a.sortable({items:".tb_repeatable_field",handle:".tb_repeatable_field_top",axis:"y",
placeholder:"tb_state_highlight",tolerance:"pointer",cursor:"move",start:_.debounce(function(b,c){void 0!==tinyMCE&&a.find(".tb_lb_wp_editor").each(function(){var a=e(this).prop("id"),b=tinymce.get(a).getContent();e(this).data("content",b);tinyMCE.execCommand("mceRemoveEditor",!1,a)})},300),stop:_.debounce(function(c,g){void 0!==tinyMCE&&a.find(".tb_lb_wp_editor").each(function(){var a=e(this).prop("id");tinyMCE.execCommand("mceAddEditor",!1,a);tinymce.get(a).setContent(e(this).data("content"))});
...
this,c=b.activeModel.get("mod_settings"),d=a.$el.closest(".tb_input").find("#widgets-search"),f=d.prev(".tb_loading_widgets"),g=function(){function g(b,c){b.addClass("selected").siblings().removeClass("selected");a.select(b,c);a.$el.removeAttr("data-validation");d.val(b.find(".widget-title").text());a.hide();a.$el.find(".widget-tpl").show()}var h=c[a.$el.prop("id")];a.el.insertAdjacentHTML("afterbegin",a.data);h?a.$el.find("[data-value]").each(function(){h===e(this).attr("data-value")&&g(e(this),
c.instance_widget)}):new SimpleBar(a.el);a.$el.find(".widget-tpl").click(function(){g(e(this),null)});a.search();f.remove();f=null;b.hasChanged=!0};f.show();if(null===this.data){for(var h in themifyBuilder.widget_css)window.top.Themify.LoadCss(themifyBuilder.widget_css[h]);themifyBuilder.widget_css=null;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_widget_items",nonce:themifyBuilder.tb_load_nonce},success:function(b){a.data=b;g()}})}else setTimeout(g,1);return this}});b.Views.register_control("widget_form",
{initialize:function(){this.render()},render:function(){var a=this;this.$el.on("change",":input",function(){a.preview_element(a.$el.find(":input").themifySerializeObject())});return this}});b.Views.register_control("layout_part",{data:[],get:function(a){var b=this;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,pid:themifyBuilder.post_ID},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(c){ThemifyBuilderCommon.showLoader("hide");
b.data=c;a()},error:function(){ThemifyBuilderCommon.showLoader("error")}})},initialize:function(){this.render()},render:function(){function a(){for(var a="<option></<option>",e=b.activeModel.get("mod_settings")[c.$el.prop("id")],g=0,h=c.data.length;g<h;++g)a+="<option"+(e===c.data[g].post_name?' selected="selected"':"")+' value="'+c.data[g].post_name+'">'+c.data[g].post_title+"</option>";c.el.insertAdjacentHTML("afterbegin",a);c.$el.change(function(){c.preview_element(this.value)})}var c=this;0===
this.data.length?this.get(a):a();return this}})})(jQuery);
