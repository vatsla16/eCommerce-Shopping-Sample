...
function themify_builder_get_control_binding_data($field) {
    ...
    if (isset($field['type'])) {
        ...
        } elseif ('builder' === $default_type|| 'repeatable' === $default_type) {
            ...
            <div class="tb_input"<?php echo ( 'wp_editor' === $option['type'] ) ? ' style="width:100%;"' : ''; ?>>
                ...
                <?php elseif ('layout' === $option['type']): ?>
                    ...
                    <p data-input-id="<?php echo $option['id'] ?>" class="tb_lb_option_child themify-layout-icon<?php if (isset($option['class'])): ?> <?php echo $option['class'] ?><?php endif; ?>"<?php echo themify_builder_get_binding_data($option), themify_builder_get_control_binding_data($option); ?>>
						...
						<?php
                        elseif ('toggle_switch' === $option['type']): ?>

	                        <?php if( ! isset($option['state']) ){
		                        $option['state'] = array(
			                        'on' => array('value'=>'yes', 'text' =>__( 'Hide', 'themify' )),
			                        'off' => array('value'=>'no', 'text' =>__( 'Show', 'themify' )),
			                        'default' => 'on'
		                        );

	                        } ?>
                            <label class="switch-wrapper <?php if (isset($option['class'])): ?> <?php echo $option['class'] ?><?php endif; ?>">
                                <input type="hidden" id="<?php echo $option['id']; ?>" name="<?php echo $option['id']; ?>" value="" class="tb_lb_option tb_switch_val" <?php echo themify_builder_get_binding_data($option), themify_builder_get_control_binding_data($option); ?>/>
                                <input type="checkbox" class="toggle_switch" data-on-val="<?php echo $option['state']['on']['value']; ?>" data-off-val="<?php echo $option['state']['off']['value']; ?>">
                                <div class="switch_label" data-on="<?php echo $option['state']['on']['text']; ?>" data-off="<?php echo $option['state']['off']['text']; ?>"></div>
                            </label>
...
if (!function_exists('themify_builder_module_settings_field')) {
    ...
    function themify_builder_module_settings_field( $module_options, $module_name = '' ) {
        ...
        // price field
        ///////////////////////////////////////////
        elseif ('repeatable' === $field['type']){
                            ?>
            <div class="tb_input <?php if(!empty($field['wrap_with_class'])) : echo $field['wrap_with_class'];  endif; ?>">
                <div id="<?php echo $field['id']; ?>" class="tb_row_js_wrapper tb_repeatable_option tb_lb_option "<?php echo themify_builder_get_control_binding_data($field); ?>>

                    <div class="tb_repeatable_field tb_repeatable_container clearfix">
                        <div class="tb_repeatable_field_content">
					        <?php themify_builder_module_settings_field_builder($field); ?>
                        </div>
                        <a href="#" class="tb_delete_row"><i class="ti ti-close"></i></a>
            ...
            <?php } else {
                    ...
                    <div class="tb_input<?php echo!empty($field['pushed']) ? ' ' . $field['pushed'] : ''; ?>">
                        ...
                        elseif ('toggle_switch' === $field['type']): ?>
                            ...
                            <label class="switch-wrapper <?php if (isset($field['class'])): ?> <?php echo $field['class'] ?><?php endif; ?>">
                                <input type="hidden" id="<?php echo $field['id']; ?>" name="<?php echo $field['id']; ?>" value="" class="tb_lb_option tb_switch_val" <?php echo $data, $control; ?>/>
                                <input type="checkbox" class="toggle_switch" data-on-val="<?php echo $field['state']['on']['value']; ?>" data-off-val="<?php echo $field['state']['off']['value']; ?>">
                                <div class="switch_label" data-on="<?php echo $field['state']['on']['text']; ?>" data-off="<?php echo $field['state']['off']['text']; ?>"></div>
                            </label>
						<?php
    ...
    function themify_builder_styling_field($styling) {
        switch ($styling['type']) {
            ...
            case 'builder':
                ...
                <div id="<?php echo $styling['id'] ?>" class="tb_row_opt_builder_wrap tb_row_js_wrapper tb_lb_option">
                    <div class="tb_repeatable_field clearfix">
                        <a href="#" class="tb_delete_row"><?php _e('Delete', 'themify') ?></a>
                        <div class="tb_repeatable_field_content">
                            <?php themify_builder_module_settings_field_builder($styling) ?>
                        </div>
                    </div>
